...
async def debug(job_offer_index=0):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print(f"Clicking 'Ver más' button #{job_offer_index + 1}...")
...
if __name__ == "__main__":
    # Test on 1st job offer (index 0)
    print("=" * 50)
    print("Testing job offer #1")
    print("=" * 50)
    asyncio.run(debug(job_offer_index=0))
    
    # To test 2nd job offer, uncomment below and run separately:
    print("\n" + "=" * 50)
    print("Testing job offer #2")
    print("=" * 50)
    asyncio.run(debug(job_offer_index=1))
    
    # To test 3rd job offer, uncomment below and run separately:
    print("\n" + "=" * 50)
    print("Testing job offer #3")
    print("=" * 50)
