"""
Competencies Transformer - Transforms competencies requirements using LDA topic modeling.

Discovers latent topics in competencies requirements and represents each requirement
...
class CompetenciesTransformer:
    """Transform competencies requirements using LDA topic modeling."""
    ...
    def fit_transform(self, competencies_texts):
        """
        Fit LDA model and transform competencies requirements.
